...
mean_hh_cases <- strsplit(format(parms_baseline["probHHtrans"]*(parms_baseline["HHsize"]-1), scientific=TRUE), "e")
minR0 <- ceiling(as.numeric(mean_hh_cases[[1]][1]))* 10^(as.numeric(mean_hh_cases[[1]][2]))
