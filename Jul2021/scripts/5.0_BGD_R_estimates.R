...
Rt
ggsave(Rt, file = paste0(git.path, "BGD_Covid-19/Jul2021/output/Rt.svg"), units = "cm", dpi = "retina", width = 15, height = 9)
ggsave(Rt, file = paste0(git.path, "BGD_Covid-19/Jul2021/output/Rt.png"), units = "cm", dpi = "retina", width = 15, height = 9)
