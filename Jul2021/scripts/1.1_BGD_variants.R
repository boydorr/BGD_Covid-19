...
# Import LATEST sequence metadata - ideally update with the CHRF build
seq2 <- read_tsv(paste0(git.path, "BGD_Covid-19/Jul2021/data/nextstrain_ncov_gisaid_asia_20210717.tsv"))
